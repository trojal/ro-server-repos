...
#define MAX_GUILD_STORAGE 5000
#define MAX_PARTY 76
#define MAX_GUILD 16+10*8	// increased max guild members +6 per 1 extension levels [Lupus]
#define MAX_GUILDPOSITION 51	// increased max guild positions to accomodate for all members [Valaris] (removed) [PoW]
