...
//BUILDIN_FUNC(getmapname); //jA addition [Silentdragon]
...
// <--- [zBuffer] List of mob control commands
	...
	//BUILDIN_DEF(getmapname,""), //[Silentdragon]
	{NULL,NULL,NULL},
};
...
/*BUILDIN_FUNC(getmapname) //[Silentdragon]
{
	...
	const char *char_name = script_getstr(st,2);//conv_str(st,& (st->stack->stack_data[st->start+2]));
