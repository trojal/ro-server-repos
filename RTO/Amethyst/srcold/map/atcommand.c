...
#endif
	{ AtCommand_Broadcast,			"@b",			    40, atcommand_broadcast }, // /b and /nb command
	{ AtCommand_LocalBroadcast,		"@lb",			    40, atcommand_localbroadcast }, // /lb and /nlb command
	{ AtCommand_LocalBroadcast, 	"@shout",	        1, atcommand_localbroadcast }, // /lb and /nlb command
