...
BUILDIN_FUNC(monster)
{
	...
	int minlv		  = script_getnum(st,8);
	int maxlv		  = script_getnum(st,9);
	const char* event = "";
	...
	mob_once_spawn(sd,m,x,y,str,class_,amount,event,minlv,maxlv);
	return 0;
}
/*==========================================
 * モンスター発生
...
BUILDIN_FUNC(areamonster)
{
	...
	int minlv		  = script_getnum(st,10);
	int maxlv		  = script_getnum(st,11);
	const char* event = "";
	...
	mob_once_spawn_area(sd,m,x0,y0,x1,y1,str,class_,amount,event,minlv,maxlv);
	return 0;
}
/*==========================================
 * モンスター削除
...
BUILDIN_FUNC(mobspawn)
{
	...
	x		=script_getnum(st,5);
	y		=script_getnum(st,6);
	minlv   =script_getnum(st,7);
	maxlv   =script_getnum(st,8);
		
	id = mob_once_spawn(map_id2sd(st->rid),map_mapname2mapid(map),x,y,str,class_,1,"",minlv,maxlv);
	script_pushint(st,id);
...
struct script_function buildin_func[] = {
	...
	BUILDIN_DEF(monster,"siisiiii*"),
	BUILDIN_DEF(areamonster,"siiiisiiii*"),
